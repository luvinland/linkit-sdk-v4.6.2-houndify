...
#define HOUND_WIFI_DEFAULT_STA_AUTO_CON		("1")

/* common config */
static const group_data_item_t g_common_data_item_array[] = {
    NVDM_DATA_ITEM("OpMode",             HOUND_WIFI_DEFAULT_OPMODE),
    NVDM_DATA_ITEM("CountryCode",        HOUND_WIFI_DEFAULT_COUNTRY_CODE),
    NVDM_DATA_ITEM("CountryRegion",      HOUND_WIFI_DEFAULT_COUNTRY_REGION),
    NVDM_DATA_ITEM("CountryRegionABand", HOUND_WIFI_DEFAULT_COUNTRY_REGION_A_BAND),
    NVDM_DATA_ITEM("RadioOff",           HOUND_WIFI_DEFAULT_RADIO_ONOFF),
    NVDM_DATA_ITEM("DbgLevel",           HOUND_WIFI_DEFAULT_N9_DEBUG_LEVEL),
    NVDM_DATA_ITEM("RTSThreshold",       HOUND_WIFI_DEFAULT_RTS_THRESHOLD),
    NVDM_DATA_ITEM("FragThreshold",      HOUND_WIFI_DEFAULT_FRAGMENT_THRESHOLD),
    NVDM_DATA_ITEM("BGChannelTable",     HOUND_WIFI_DEFAULT_BG_CHANNEL_TABLE),
    NVDM_DATA_ITEM("AChannelTable",      HOUND_WIFI_DEFAULT_A_CHANNEL_TABLE),
    NVDM_DATA_ITEM("syslog_filters",     HOUND_WIFI_DEFAULT_SYSLOG_FILTERS),
    NVDM_DATA_ITEM("WiFiPrivilegeEnable",HOUND_WIFI_DEFAULT_WIFI_PRIVILEGE_ENABLE),
    NVDM_DATA_ITEM("StaFastLink",        HOUND_WIFI_DEFAULT_STA_FAST_LINK),
};

/* STA config */
static const group_data_item_t g_sta_data_item_array[] = {
    NVDM_DATA_ITEM("LocalAdminMAC",      HOUND_WIFI_DEFAULT_STA_LOCAL_ADMIN_MAC),
    NVDM_DATA_ITEM("MacAddr",            HOUND_WIFI_DEFAULT_STA_MAC_ADDR),
    NVDM_DATA_ITEM("Ssid",               HOUND_WIFI_DEFAULT_STA_SSID),
    NVDM_DATA_ITEM("SsidLen",            HOUND_WIFI_DEFAULT_STA_SSID_LEN),
    NVDM_DATA_ITEM("BssType",            HOUND_WIFI_DEFAULT_STA_BSS_TYPE),
    NVDM_DATA_ITEM("Channel",            HOUND_WIFI_DEFAULT_STA_CHANNEL),
    NVDM_DATA_ITEM("BW",                 HOUND_WIFI_DEFAULT_STA_BANDWIDTH),
    NVDM_DATA_ITEM("WirelessMode",       HOUND_WIFI_DEFAULT_STA_WIRELESS_MODE),
    NVDM_DATA_ITEM("BADecline",          HOUND_WIFI_DEFAULT_STA_BA_DECLINE),
    NVDM_DATA_ITEM("AutoBA",             HOUND_WIFI_DEFAULT_STA_AUTO_BA),
    NVDM_DATA_ITEM("HT_MCS",             HOUND_WIFI_DEFAULT_STA_HT_MCS),
    NVDM_DATA_ITEM("HT_BAWinSize",       HOUND_WIFI_DEFAULT_STA_HT_BA_WINDOW_SIZE),
    NVDM_DATA_ITEM("HT_GI",              HOUND_WIFI_DEFAULT_STA_HT_GI),
    NVDM_DATA_ITEM("HT_PROTECT",         HOUND_WIFI_DEFAULT_STA_HT_PROTECT),
    NVDM_DATA_ITEM("HT_EXTCHA",          HOUND_WIFI_DEFAULT_STA_HT_EXT_CHANNEL),
    NVDM_DATA_ITEM("WmmCapable",         HOUND_WIFI_DEFAULT_STA_WMM_CAPABLE),
    NVDM_DATA_ITEM("ListenInterval",     HOUND_WIFI_DEFAULT_STA_LISTEN_INTERVAL),
    NVDM_DATA_ITEM("AuthMode",           HOUND_WIFI_DEFAULT_STA_AUTH_MODE),
    NVDM_DATA_ITEM("EncrypType",         HOUND_WIFI_DEFAULT_STA_ENCRYPT_TYPE),
    NVDM_DATA_ITEM("WpaPsk",             HOUND_WIFI_DEFAULT_STA_WPA_PSK),
    NVDM_DATA_ITEM("WpaPskLen",          HOUND_WIFI_DEFAULT_STA_WPA_PSK_LEN),
    NVDM_DATA_ITEM("PMK_INFO",           "0"),
    NVDM_DATA_ITEM("PairCipher",         HOUND_WIFI_DEFAULT_STA_PAIR_CIPHER),
    NVDM_DATA_ITEM("GroupCipher",        HOUND_WIFI_DEFAULT_STA_GROUP_CIPHER),
    NVDM_DATA_ITEM("DefaultKeyId",       HOUND_WIFI_DEFAULT_STA_DEFAULT_KEY_ID),
    NVDM_DATA_ITEM("SharedKey",          HOUND_WIFI_DEFAULT_STA_SHARE_KEY),
    NVDM_DATA_ITEM("SharedKeyLen",       HOUND_WIFI_DEFAULT_STA_SHARE_KEY_LEN),
    NVDM_DATA_ITEM("PSMode",             HOUND_WIFI_DEFAULT_STA_POWER_SAVE_MODE),
    NVDM_DATA_ITEM("KeepAlivePeriod",    HOUND_WIFI_DEFAULT_STA_KEEP_ALIVE_PERIOD),
    NVDM_DATA_ITEM("BeaconLostTime",     HOUND_WIFI_DEFAULT_STA_BEACON_LOST_TIME),
    NVDM_DATA_ITEM("ApcliBWAutoUpBelow", HOUND_WIFI_DEFAULT_APCLI_BW_AUTO_UP_BELOW),
    NVDM_DATA_ITEM("StaKeepAlivePacket", HOUND_WIFI_DEFAULT_STA_KEEP_ALIVE_PACKET),
    NVDM_DATA_ITEM("AutoCon",		HOUND_WIFI_DEFAULT_STA_AUTO_CON),
};

/* AP config */
static const group_data_item_t g_ap_data_item_array[] = {
    NVDM_DATA_ITEM("LocalAdminMAC",      HOUND_WIFI_DEFAULT_AP_LOCAL_ADMIN_MAC),
    NVDM_DATA_ITEM("MacAddr",            HOUND_WIFI_DEFAULT_AP_MAC_ADDR),
    NVDM_DATA_ITEM("Ssid",               HOUND_WIFI_DEFAULT_AP_SSID),
    NVDM_DATA_ITEM("SsidLen",            HOUND_WIFI_DEFAULT_AP_SSID_LEN),
    NVDM_DATA_ITEM("Channel",            HOUND_WIFI_DEFAULT_AP_CHANNEL),
    NVDM_DATA_ITEM("BW",                 HOUND_WIFI_DEFAULT_AP_BANDWIDTH),
    NVDM_DATA_ITEM("WirelessMode",       HOUND_WIFI_DEFAULT_AP_WIRELESS_MODE),
    NVDM_DATA_ITEM("AutoBA",             HOUND_WIFI_DEFAULT_AP_AUTO_BA),
    NVDM_DATA_ITEM("HT_MCS",             HOUND_WIFI_DEFAULT_AP_HT_MCS),
    NVDM_DATA_ITEM("HT_BAWinSize",       HOUND_WIFI_DEFAULT_AP_HT_BA_WINDOW_SIZE),
    NVDM_DATA_ITEM("HT_GI",              HOUND_WIFI_DEFAULT_AP_HT_GI),
    NVDM_DATA_ITEM("HT_PROTECT",         HOUND_WIFI_DEFAULT_AP_HT_PROTECT),
    NVDM_DATA_ITEM("HT_EXTCHA",          HOUND_WIFI_DEFAULT_AP_HT_EXT_CHANNEL),
    NVDM_DATA_ITEM("WmmCapable",         HOUND_WIFI_DEFAULT_AP_WMM_CAPABLE),
    NVDM_DATA_ITEM("DtimPeriod",         HOUND_WIFI_DEFAULT_AP_DTIM_PERIOD),
    NVDM_DATA_ITEM("AuthMode",           HOUND_WIFI_DEFAULT_AP_AUTH_MODE),
    NVDM_DATA_ITEM("EncrypType",         HOUND_WIFI_DEFAULT_AP_ENCRYPT_TYPE),
    NVDM_DATA_ITEM("WpaPsk",             HOUND_WIFI_DEFAULT_AP_WPA_PSK),
    NVDM_DATA_ITEM("WpaPskLen",          HOUND_WIFI_DEFAULT_AP_WPA_PSK_LEN),
    NVDM_DATA_ITEM("PairCipher",         HOUND_WIFI_DEFAULT_AP_PAIR_CIPHER),
    NVDM_DATA_ITEM("GroupCipher",        HOUND_WIFI_DEFAULT_AP_GROUP_CIPHER),
    NVDM_DATA_ITEM("DefaultKeyId",       HOUND_WIFI_DEFAULT_AP_DEFAULT_KEY_ID),
    NVDM_DATA_ITEM("SharedKey",          HOUND_WIFI_DEFAULT_AP_SHARE_KEY),
    NVDM_DATA_ITEM("SharedKeyLen",       HOUND_WIFI_DEFAULT_AP_SHARE_KEY_LEN),
    NVDM_DATA_ITEM("HideSSID",           HOUND_WIFI_DEFAULT_AP_HIDDEN_SSID),
    NVDM_DATA_ITEM("RekeyInterval",      HOUND_WIFI_DEFAULT_AP_REKEY_INTERVAL),
    NVDM_DATA_ITEM("AutoChannelSelect",  HOUND_WIFI_DEFAULT_AP_AUTO_CHANNEL_SELECT),
    NVDM_DATA_ITEM("BcnDisEn",           HOUND_WIFI_DEFAULT_AP_BEACON_DISABLE),
};
...
int32_t wifi_config_init(wifi_cfg_t *wifi_config)
{
    ...
    len = sizeof(buff);
    nvdm_read_data_item("STA", "AutoCon", buff, &len);
    wifi_config->sta_auto_con = (uint8_t)atoi((char *)buff);
